...
class MLP_Complete:
    ...
    """
    Args:
        a (scalar): output generated by neural network.

    Return 
    ------
    p (integer): binary output of the last neuron
    """
    def predict_binary(self,a3,threshold = 0.5):
        p = (a3 >= threshold).astype(int) # convierte bool a int y aplana #(.ravel si quisiera que fuese el vector entero)
        return p;
